...
function SheetTrigger({ asChild, children, ...props }: React.ButtonHTMLAttributes<HTMLButtonElement> & { asChild?: boolean }) {
...
function SheetContent({ className, side = "right", children, ...props }: React.HTMLAttributes<HTMLDivElement> & { side?: "left" | "right" | "top" | "bottom" }) {
  ...
  return (
    <div className="fixed inset-0 z-50">
      ...
      <div
        className={cn(
          "fixed z-50 bg-background p-6 shadow-lg border-border",
          sideClasses[side],
          className
        )}
        {...props}
